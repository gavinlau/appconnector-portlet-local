...
/**
 * Provides the local service interface for Connector. Methods of this
 * service will not have security checks based on the propagated JAAS
 * credentials because this service can only be accessed from within the same
 * VM.
 *
 * @author Administrator
 * @see ConnectorLocalServiceUtil
...
public interface ConnectorLocalService extends BaseLocalService,
	InvokableLocalService, PersistedModelLocalService {
	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this interface directly. Always use {@link ConnectorLocalServiceUtil} to access the connector local service. Add custom service methods to {@link com.wits.portal.service.impl.ConnectorLocalServiceImpl} and rerun ServiceBuilder to automatically copy the method declarations to this interface.
	 */
